...
class FreshVegitableItems extends StatefulWidget {
  ...
  @override
  State<FreshVegitableItems> createState() =>
      _FreshVegitableItemsState();
}
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.only(bottom: 3, left:13),
                              child: Container(
                                alignment: Alignment.centerLeft,
                                child: const Text(
                                  'Potato Chipsona',maxLines: 2,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                                  softWrap: false,
                                  style: TextStyle(
                                          ...
                                          child: const Column(
                                            children: [
                                              Text(
                                                ...
                                                style: TextStyle(
                                                    fontSize: 15,
                                                    fontWeight: FontWeight.w500, color: Color(0XFFDF2C25)),
                                              ),
                                            ],
                                          ),
                                        )),
